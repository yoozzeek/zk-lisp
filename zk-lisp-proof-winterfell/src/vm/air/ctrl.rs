...
//! Control-plane constraints for VM opcode and selector wiring.
//!
//! Ensures one-hot opcode decoding, selector booleanity,
//! routing of role selectors and PC/ROM schedule invariants
//! for each VM step.
...
mod tests {
    use super::*;
    use crate::vm::layout::{Columns, POSEIDON_ROUNDS};
    ...
    fn sponge_selectors_gated_off_without_feature() {
        ...
        let pi_no_sponge = zk_lisp_proof::pi::PublicInputs::default();
    ...
    fn sponge_selectors_on_feature_affect_eval() {
        ...
        pi.feature_mask |= zk_lisp_proof::pi::FM_SPONGE | zk_lisp_proof::pi::FM_VM;
