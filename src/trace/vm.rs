...
use crate::trace::{TraceBuilderContext, TraceModule, poseidon::apply_level_absorb, ram::RamEvent};
use crate::{error, schedule, utils};
...
mod tests {
    use super::*;
    use crate::compiler::{CompilerMetrics, builder, builder::Op, compile_entry};
